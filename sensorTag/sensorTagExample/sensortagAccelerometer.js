...
SensorTag.discover(function(tag) {
  ...
  function connectAndSetUpMe() { // attempt to connect to the tag
    ...
    // when you connect and device is setup, call setPeriod
    tag.connectAndSetUp(setPeriod);
  }

  function setPeriod() { // attempt to set the notification period
    console.log('setPeriod');
    // when you set the period, call enableAccelMe
    tag.setAccelerometerPeriod(1000, enableAccelMe);
  }
